      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              ...
              />              <button
                ...
                className="px-4 py-2 text-blue-500 hover:text-blue-700 bg-transparent dark:bg-transparent rounded-md transition-all duration-200 transform hover:-translate-y-1 hover:shadow-[0_5px_0_0_rgba(59,130,246,0.2)] active:translate-y-0 active:shadow-[0_2px_0_0_rgba(59,130,246,0.2)] before:absolute before:inset-0 before:bg-blue-200/10 dark:before:bg-blue-400/10 before:rounded-md before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-200 border-b-4 border-transparent hover:border-blue-200 dark:hover:border-blue-800 relative"
              >
                Add
              </button>
            </div>
          ...
          <div>
            ...
            <button
              onClick={onClose}
              className="w-full px-4 py-2 text-blue-500 hover:text-blue-700 bg-transparent dark:bg-transparent rounded-md transition-all duration-200 transform hover:-translate-y-1 hover:shadow-[0_8px_0_0_rgba(59,130,246,0.2)] active:translate-y-0 active:shadow-[0_4px_0_0_rgba(59,130,246,0.2)] before:absolute before:inset-0 before:bg-blue-200/10 dark:before:bg-blue-400/10 before:rounded-md before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-200 border-b-4 border-transparent hover:border-blue-200 dark:hover:border-blue-800 relative"
            >
              Done
            </button>
          </div>
