        ...
        <div className="flex flex-wrap gap-3">
          ...
          <div className="flex items-center">
            ...
            <div className="relative group">
              ...
              <div className={`absolute top-1/2 right-2 transform -translate-y-1/2 w-3 h-3 rounded-full ${getPriorityColor(priority).bg} transition-all duration-300 group-hover:scale-125`}></div>
